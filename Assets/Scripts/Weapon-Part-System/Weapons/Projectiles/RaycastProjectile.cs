...
public abstract class RaycastProjectile : BaseProjectile
{
    ...
    // --- NEW: Pass the sourceLayer down to the base script ---
    ...
    protected override void Update()
    {
        ...
        if (useGravity) currentVelocity += Physics.gravity * gravityMultiplier * Time.deltaTime;
        ...
        if (currentVelocity != Vector3.zero) transform.rotation = Quaternion.LookRotation(currentVelocity);
        previousPosition = transform.position;
    }
}